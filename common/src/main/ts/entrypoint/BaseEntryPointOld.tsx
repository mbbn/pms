...
export default abstract class BaseEntryPointOld extends React.Component<any, any> {
    ...
    constructor(props: any, context: any) {
        super(props, context);
        BaseEntryPointOld.instance = this;
    }
    static render(component: any): void {
        const rootElement = document.getElementById(BaseEntryPointOld.ROOT_DIV_ID);
